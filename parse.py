...
angerArray = ["you might come of a bit angry", "you might need to chill.", "you might need to take it down a notch.", "you sound a bit angry.", "you sound sort of moody."]
...
if (today11pm < nowtest< today1159pm):
	print("Business hours are over, are you sure?")
elif (today12am < nowtest < today1259am):
	print("Should you be texting this person this late")
elif (today1am < nowtest< today230am):
	print("Heading back from the bars? Just checking. Proceed?")
elif (today231am < nowtest< today5am):
	print("This is not an hour to text someone, you can probably wait a couple of hours, proceed?")
